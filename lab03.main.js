 ...
 * @return {object} returnObj - return object
 * @return {string} returnObj.ipv4 - An IPv4 address
 * @return {string} returnObj.ipv6 - mapped IPv4 address in IPv6
 */
function getFirstIpAddress(cidrStr, callback) {
  ...
  return callback(returnObj, callbackError);
}
